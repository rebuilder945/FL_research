#class Stock
class Stock:
    "Stock Informaion Class"
    def__init__(self,code,name,priceYesterday,priceToday):
        self._code=code
        self._name=name
        self._priceYesterday=priceYesterday
        sel._priceToday=priceToday
    def getName(self):
        return self._name
    def getCode(self):
        return self._code
    ...
    def getChangePercent(self):
        a=(self._priceToday-self._priceYesterday)/sel._priceYesterday
        return a
