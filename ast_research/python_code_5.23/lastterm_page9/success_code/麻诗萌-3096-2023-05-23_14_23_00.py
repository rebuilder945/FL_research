...
class Stock:
    ...
    def setPriceYesterday(self,npriceYesterday):
        self.priceYesterday=npriceYesterday
    def setPriceToday(self,npriceToday):
        self.priceToday=npriceToday   
    def getChangePercent(self):
        return (self.priceToday-self.priceYesterday)/self.priceYesterday   
    "user defined class: Stock Information Class"     
