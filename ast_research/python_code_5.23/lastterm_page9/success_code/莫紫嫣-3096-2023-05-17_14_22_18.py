...
class Stock:
    ...
    def getChangePercent(self,priceYesterday,priceToday):
        priceYesterday=self.priceYesterday
        priceToday=self.priceToday
        (self.priceToday-priceYesterday)/priceYesterday
